...
const Card = ({
  ...
  // Using neutral and subtle monochrome themes to match FreelanceOS's professional AI look
    ...
    >
      <div className="bg-white p-2 rounded-[25px] shadow-[0px_10px_20px_0px_#D3D3D3] border border-neutral-100">
        ...
        >
          ...
          <h3 className="text-xl font-semibold text-neutral-800 leading-tight mb-[10px]">
            {title}
          </h3>
...
export default function HowItWorks({
  ...
  const defaultFeatures: Step[] = [
    {
      ...
      description:
        "Copy a freelance project description, paste a project URL, or upload a screenshot. FreelanceOS turns the opportunity into structured information ready for analysis.",
      colorTheme: "blue",
    },
    {
      title: "Understand the Project",
      description:
        "AI extracts the real requirements, deliverables, skills, technologies, timeline, budget, urgency, and scope so you know what the client is actually asking for.",
      colorTheme: "purple",
    },
    {
      title: "Discover Client Intelligence",
      description:
        "Find publicly available client or company information, relevant websites, professional profiles, business profiles, and public contact sources with confidence and evidence.",
      colorTheme: "orange",
    },
    {
      title: "Find the Risks & Your Fit",
      description:
        "Uncover hidden requirements, missing information, potential risks, and compare the opportunity with your skills, experience, technology and portfolio.",
      colorTheme: "blue",
    },
    {
      title: "Price, Position & Apply",
      description:
        "Get explainable pricing guidance, personalized positioning, and a proposal based on your real experience — then verify the proposal before you send it.",
      colorTheme: "purple",
    },
  ];
  ...
  return (
    <section className={`w-full ${className}`}>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 mb-8 text-center pt-24">
        <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-foreground mb-4">
          How FreelanceOS Works
        </h2>
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          From a freelance project description to a clear decision — understand the opportunity, research the client, uncover risks, and apply with confidence.
        </p>
      </div>
      
      <LazyMotion features={domAnimation}>
        <div
          className={`bg-white max-md:pt-10 max-md:pb-25 md:py-20 px-8 relative`}
        >
          <div
